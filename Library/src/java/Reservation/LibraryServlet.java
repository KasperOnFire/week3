...
public class LibraryServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (dao.getLibStatus(uno) && ino != null) {
            dao.reserveItem(ino, uno);
            dao.rescountUp(uno);
            response.sendRedirect("LibraryMain.jsp");
        } else {
             request.getRequestDispatcher("/TooManyRes.jsp").forward(request, response);
        }
